...
//     // Include `name`, `role`, etc., in the JWT payload if needed
...
//     if (loginType === "google") {
//       // Appwrite handles Google OAuth2 session creation directly on the frontend
...
//       });
//     } else {
//       // Handle existing email-password login system
//       const user = await User.findOne({ email });
