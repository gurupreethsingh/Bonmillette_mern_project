...
const ProductPurchaseHistory = () => {
    ...
    const fetchProductNames = async () => {
      try {
        const response = await fetch(
          "http://localhost:3006/api/get-product-names"
        );
  ...
  const fetchPurchaseHistory = async () => {
    ...
    try {
      const url = `http://localhost:3006/api/get-product-purchase-history?productId=${selectedProduct}&startDate=${startDate}&endDate=${endDate}`;
